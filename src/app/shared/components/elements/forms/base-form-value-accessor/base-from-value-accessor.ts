...
export class BaseFormValueAccessorComponent implements ControlValueAccessor, OnDestroy, Validator {
  ...
  public registerOnChange(fn: () => void): void {
    this.formGroup.valueChanges.pipe(takeUntil(this._unsubscribeAll)).subscribe(fn);
  }
